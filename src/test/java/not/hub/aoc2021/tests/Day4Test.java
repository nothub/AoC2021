...
class Day4Test {
    ...
    private static final List<String> example = Collections.unmodifiableList(InputParser.stringList("inputs/day4_example"));
    private static final List<String> input = Collections.unmodifiableList(InputParser.stringList("inputs/day4"));
